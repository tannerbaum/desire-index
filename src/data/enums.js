const ALLIES = {
    ...
    Jones: "Brandon Jones",
    Moore: "Ben Moore",
    Damiani: "Michael Damiani",
    Hinck: "Ian Hinck",
    Ellis: "Bradley Ellis",
    Bloodworth: "Daniel Bloodworth",
    Casanova: "Don Casanova",
    Guest: "Guest"
};

const GAMES = {
    BabylonsFall: "Babylon's Fall",
    SonicRacing: "Team Sonic Racing",
    SkullAndBones: "Skull and Bones",
    Fallout: "Fallout 76",
    ...
    Gears: "Gears 5",
    Cod: "Call of Duty: Black Ops IIII",
    Forza: "Forza Horizon 4",
    Tomb: "Shadow of the Tomb Raider",
